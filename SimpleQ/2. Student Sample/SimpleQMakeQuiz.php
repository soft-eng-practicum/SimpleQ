        ...
        <?php
            ...
            if($username =="Daaps" && $password =="Daaps")
            {
                ...
                echo "<a href='SimpleQuizEdit.php' class='btn btn-info' role='button'>Edit Quiz</a>&nbsp&nbsp
                	  <a href='SimpleQNew.php' class='btn btn-info' role='button'>New Quiz</a><br/><br/>
                      <a href='DemoQuiz01Results.txt' class='btn btn-info' role='button'>View DemoQuiz01 Results</a>
                      <a href='DemoQuiz02Results.txt' class='btn btn-info' role='button'>View DemoQuiz02 Results</a>";
            }
            else

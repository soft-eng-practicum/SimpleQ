<html>
    ...
    <body>
        ...
        <div class="container" style = "text-align:left">  
        	<h3>Welcome to Demo Quiz 01!</h3>
            <h5/>You have 3 attempts to get through all 13 questions before having to start over.<h5/>
            <hr/>
            <form method='post' enctype='multipart/form-data' action="DemoQuiz01.php">
